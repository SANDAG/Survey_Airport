...
config_file <- paste0(interim_dir, "expansion_config_departing_only_model_respondents.yaml")
...
model_respondents <- script_config$parameters$model_respondents
...
```{r preparation}
'model_respondent_bool' %in% colnames(survey_df)
  ```
...
if (model_respondents) {
  working_survey_df <- working_survey_df %>%
  filter(model_respondent_bool == "True")
}
